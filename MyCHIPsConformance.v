...
Goals. Define first, add reflection later to rapidly solve goals.
The originator will have 2 IDs 0 and size, preventing the need for mutation
Project an arbitrary node not just the last node
